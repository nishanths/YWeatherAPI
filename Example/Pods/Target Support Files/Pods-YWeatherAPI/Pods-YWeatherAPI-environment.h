...
// YWeatherAPI
#define COCOAPODS_POD_AVAILABLE_YWeatherAPI
#define COCOAPODS_VERSION_MAJOR_YWeatherAPI 0
#define COCOAPODS_VERSION_MINOR_YWeatherAPI 1
#define COCOAPODS_VERSION_PATCH_YWeatherAPI 0
